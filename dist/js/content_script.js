...
function captureInteraction(eventType, target, timestamp, uuid, scrollDistance) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
let lastScrollTop = window.scrollY || document.documentElement.scrollTop;
let accumulatedScrollDistance = 0;
const handleScrollStop = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.debounce)(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (accumulatedScrollDistance > 0) {
            ...
            yield captureInteraction('scroll', null, timestamp, uuid, accumulatedScrollDistance);
